...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Identifier', { fg = c.vscLightBlue, bg = c.vscBack })
    ...
    -- Git Signs
    hl(0, 'GitSignsAdd', { fg = c.vscGreen, bg = c.vscBack })
    hl(0, 'GitSignsChange', { fg = c.vscYellow, bg = c.vscBack })
    hl(0, 'GitSignsDelete', { fg = c.vscRed, bg = c.vscBack })
    ...
    hl(0, "DiagnosticSignError", {fg= c.vscRed, bg = c.vscBack })
    hl(0, "DiagnosticSignWarn", {fg = c.vscYellow, bg = c.vscBack })
    hl(0, "DiagnosticSignInfo", {fg = c.vscBlue, bg = c.vscBack })
    hl(0, "DiagnosticSignHint", {fg = c.vscBlue, bg = c.vscBack })
    hl(0, "DiagnosticSignOk", {fg = c.vscBlueGreen, bg = c.vscBack })
